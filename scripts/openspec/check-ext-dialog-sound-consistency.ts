...
/** Rule kind: "name" honors the allowlist; "semantic" never does. */
export type ConsistencyRuleKind = "name" | "semantic";

export type ConsistencyRule = readonly [ruleId: string, pattern: RegExp, kind: ConsistencyRuleKind];
...
export const RULES: readonly ConsistencyRule[] = [
...
export const checkDocument = (relativePath: string, content: string): string[] => {
