...
set APP_DIR=%USERPROFILE%\.opentray\create\local-cmd-demo\app
...
if not exist "%APP_DIR%\package.json" (
  ...
  call pnpm --dir %REPO% create-opentray create --app-id local.cmd-demo --app-name "Cmd Demo" --exec python --arg=-m --arg=http.server --arg=8137 --cwd "%USERPROFILE%\opentray-owner-walkthrough\cmd-content" --toolbar --skip-install --pm npm --json
)
cd /d "%APP_DIR%"
