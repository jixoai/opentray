...
| Area                               | Files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Runtime host + lifecycle           | `openspec/changes/opentray-v0-9/specs/runtime-host/spec.md`, `packages/cli/src/cli.ts`, `packages/cli/src/daemon/lifecycle.ts`, `packages/cli/src/daemon/paths.ts`, `packages/cli/src/daemon/broker-command.ts`, `packages/cli/src/local-broker.ts`, `packages/cli/src/local-broker.test.ts`, `packages/cli/src/native-runtime.ts`, `packages/cli/src/native-runtime.test.ts`, `packages/cli/src/runtime-binding-transport.ts`, `packages/cli/src/node.ts`, `crates/opentray-runtime-node/src/lib.rs`, `crates/opentray-core/src/broker.rs`, `crates/opentray-core/src/kernel.rs`, `crates/opentray-bin/src/main.rs`                                                                                                                                                                                        |
