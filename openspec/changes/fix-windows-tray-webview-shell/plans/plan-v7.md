...
- Round: 6
- Status: Windows native size/move interaction now distinguishes pure dragging from observed resize before the legacy white-block workaround; native visual acceptance is pending.
