...
- [ ] Add the committed independent repository as a root git submodule and verify a fresh recursive checkout.
- [ ] Run the full core build/verify/strict OpenSpec gates after the submodule gitlink is present.
