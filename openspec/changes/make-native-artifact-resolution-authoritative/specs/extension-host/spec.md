...
#### Scenario: Dynamic library exports required identity and lifecycle symbols
...
#### Scenario: Exact package artifact is deterministic
...
#### Scenario: Extension owns and releases every returned buffer
...
#### Scenario: Session cleanup preserves detailed failure
