...
6. Start source WebView examples without sharing a neutral broker endpoint.
-->
...
- Round: 3
- Status: Source-example broker isolation and Windows-visible validation are complete; self-review is refreshed.
