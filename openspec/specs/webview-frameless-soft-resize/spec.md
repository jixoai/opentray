# webview-frameless-soft-resize Specification

## Purpose

Define the common WebView user-resize contract, true Windows frameless shell behavior, and Windows-native soft resizing without moving WebView policy into the broker or application pages.
## Requirements
