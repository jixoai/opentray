...
- **GIVEN** the native probe and `example:win32-bug` use the same Windows environment
- **WHEN** both execute the same material, paint, frame, and size sequence
