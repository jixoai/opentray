...
- **GIVEN** the interview record identifies a durable platform or ownership boundary
...
- **GIVEN** the interview record identifies durable facts, projections, or state boundaries
- **WHEN** this spec is written
...
Full updated requirement block goes here when modifying an existing requirement.
