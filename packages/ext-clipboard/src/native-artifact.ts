// Orthogonal intents (2026-09-18; add-ext-clipboard task 4.1):
// 1. Declare the official clipboard platform library catalog as
...
//    by add-ext-dialog section 6.2 and add-ext-sound).
...
export const CLIPBOARD_NATIVE_ARTIFACT = {
  kind: "embedded",
